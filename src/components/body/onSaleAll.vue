<template>
    <p v-if="demoData === 0" class="h3 demoData">DEMO</p>
    <!-- 選單 -->
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane fade" id="data_1" role="tabpanel" v-if="onSale_1">
            <OverlayScrollbarsComponent defer>
                <ul class="row onsale__box">
                    <ProductItem v-for="(item, index) in getRandomProducts(onSale_1.products, 10)" :key="index" :item="item" />
                </ul>
            </OverlayScrollbarsComponent>
        </div>
        <div class="tab-pane fade" id="data_2" role="tabpanel" v-if="onSale_2">
            <OverlayScrollbarsComponent defer>
                <ul class="row onsale__box">
                    <ProductItem v-for="(item, index) in getRandomProducts(onSale_2.products, 10)" :key="index" :item="item" />
                </ul>
            </OverlayScrollbarsComponent>
        </div>
        <div class="tab-pane fade" id="data_3" role="tabpanel" v-if="onSale_3">
            <OverlayScrollbarsComponent defer>
                <ul class="row onsale__box">
                    <ProductItem v-for="(item, index) in getRandomProducts(onSale_3.products, 10)" :key="index" :item="item" />
                </ul>
            </OverlayScrollbarsComponent>
        </div>
        <div class="tab-pane fade" id="data_4" role="tabpanel" v-if="onSale_4">
            <OverlayScrollbarsComponent defer>
                <ul class="row onsale__box">
                    <ProductItem v-for="(item, index) in getRandomProducts(onSale_4.products, 10)" :key="index" :item="item" />
                </ul>
            </OverlayScrollbarsComponent>
        </div>
    </div>
...
import ProductItem from './onSale_item.vue'
